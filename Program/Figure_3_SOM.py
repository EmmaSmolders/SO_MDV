...
plt.tight_layout()
plt.savefig(directory_figures +'Energetics_SOM_SO30_new.pdf')
plt.show()

#%%

plt.figure()
#plt.plot(time_1, APE_1_SO30)
#plt.plot(time_2, APE_2_SO30)
#plt.plot(time_3, APE_3_SO30)
plt.plot(time, APE_SO30)
